...
class HabitUpdateScreen extends StatefulWidget {
  const HabitUpdateScreen({Key? key}) : super(key: key);
...
class _HabitUpdateScreenState extends State<HabitUpdateScreen> {
  final GlobalKey<FormState> _habitUpdateFormKey = GlobalKey<FormState>();
  ...
  onTapCreate() async {
    ...
    } else if (_habitUpdateFormKey.currentState!.validate()) {
      _habitUpdateFormKey.currentState!.save();
